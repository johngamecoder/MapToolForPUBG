...
pair<string, string> ResourceInfo::GetFileNameWithoutX(const TAG_RES_STATIC tag)
{
    ...
    return make_pair("../../TeamAvengers_PUBG/PUBG/Client/Resource/Static/" + filePath + fileName + "/", fileName);
}
...
pair<string, string> ResourceInfo::GetPathFileName(const TAG_RES_STATIC tag)
{
    ...
    return make_pair("../../TeamAvengers_PUBG/PUBG/Client/Resource/Static/" + filePath + fileName + "/", fileName + ".X");
}
