...
float4x4 gInvWMatrix : WorldInverse;
...
VS_OUTPUT ToonShader_Pass_0_Vertex_Shader_vs_main( VS_INPUT Input )
{
   ...
   float4 localLightPosition = mul(gWorldLightPosition, gInvWMatrix);
   float3 lightDir = normalize(Input.mPosition.xyz - localLightPosition.xyz);
